               ...
               <div key={item.id} className="review">
                  ...
                  <div className="text">
                        ...
                        {item.img_slider && <ul className="style-none d-flex flex-wrap review-gallery pb-30">
                           ...
                           <li>
                              <div className="position-relative more-img">
                                 <img src={agencyDetailsImg_6} alt="" />
                                 <span>3+</span>
                                 {item.img_slider?.map((img_item, index) => (
                     ...
                     <div className="d-flex review-help-btn">
                        <a href="#" className="me-5"><i className="fa-sharp fa-regular fa-thumbs-up"></i>
                           <span>Helpful</span>
                        </a>
                        <a href="#"><i className="fa-sharp fa-regular fa-flag-swallowtail"></i>
                           <span>Flag</span>
                        </a>
                     </div>
                  </div>
