...
const SidebarInfo = ({ data }: { data: Property["data"][0] }) => {
  return (
    <>
      <img
        src={infoAvatar.src}
      ...
      <div className="text-center mt-25">
        <h6 className="name">
          {data?.attributes?.owner?.data?.attributes?.name}
        </h6>
      ...
      <div className="divider-line mt-40 mb-45 pt-20">
        <ul className="style-none">
          <li>
            Phone:{" "}
            <span>
              {data?.attributes.owner?.data?.attributes?.contact_number}
            </span>
          </li>
          {/* <li>
            Email:{" "}
            <span>
              <a href="mailto:akabirr770@gmail.com">akabirr770@gmail.com</a>
            </span>
          </li>
          <li>
            Phone:{" "}
