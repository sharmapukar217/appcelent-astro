   ...
   return (
      <div className={`footer-one ${style ? "dark-bg" : ""}`}>
         <div className="position-relative z-1">
                     ...
                     <div className={`footer-intro ${style ? "position-relative z-1" : ""}`}>
                        <div className="bg-wrapper">
                           <div className="logo mb-20">
                              <a href="/">
                                 <img src={style ? footerLogo_2.src : footerLogo_1.src} alt="" />
                              </a>
                           </div>
                           <p className="mb-60 lg-mb-40 md-mb-20">11910 Clyde Rapid Suite 70, Willyand, Virginia, United States</p>
                           <h6>CONTACT</h6>
                           <a href="#" className={`email tran3s mb-70 lg-mb-50 ${style ? "font-garamond" : "fs-24 text-decoration-underline"}`}>homyreal@demo.com</a>
                           <ul className="style-none d-flex align-items-center social-icon">
                              {icon_1.map((icon, i) => (
                                 <li key={i}><a href="#"><i className={`fa-brands fa${style ? "" : "-square"}-${icon}`}></i></a></li>
                              ))}
                           </ul>
                        </div>
                        {style && <img src={footerShape_1} alt="" className="lazy-img shapes shape_01" />}
                     </div>
                  </div>
            ...
            {style && <img src={footerShape_2.src} alt="" className="lazy-img shapes shape_02" />}
         </div>
      </div>
   )
}
